...
def speech():   
    ...
    data = ['learn my friend','capture','data','snap','memorize','friend']
    train = ['train','model','face','faces']
    recognize = ['recognize','recollect','who','recognise']
    object_rec = ['what','object','detect','help','objects']
